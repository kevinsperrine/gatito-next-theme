...
module.exports = {
  ...
  "editorGroupHeader.border": theme.missing,
  ...
  "tab.hoverForeground": theme.missing,
  "tab.unfocusedHoverForeground": theme.missing,
  "tab.hoverBorder": theme.missing,
  "tab.unfocusedHoverBorder": theme.missing,
  ...
  "editorPane.background": theme.missing,
};
