...
module.exports = {
  ...
  "editor.selectionBackground": theme.foregroundDark,
  "editor.selectionForeground": theme.foregroundAlpha50,
  ...
  "editorBracketHighlight.foreground1": theme.white,
  "editorBracketHighlight.foreground2": theme.blue,
  "editorBracketHighlight.foreground3": theme.cyan,
  "editorBracketHighlight.foreground4": theme.green,
  "editorBracketHighlight.foreground5": theme.yellow,
  "editorBracketHighlight.foreground6": theme.orange,
  "editorBracketHighlight.unexpectedBracket.foreground": theme.missing,
  "editorCodeLens.foreground": theme.foregroundDark,
  "editorCursor.background": theme.background,
  "editorCursor.foreground": theme.foregroundDark,
