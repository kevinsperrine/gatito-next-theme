...
module.exports = {
  ...
  "editorStickyScroll.background": theme.slate[600],
  "editorStickyScroll.border": theme.slate[700],
  "editorStickyScroll.shadow": theme.slate[800],
  "editorStickyScrollGutter.background": theme.slate[600],
  "editorStickyScrollHover.background": theme.slate[600],
